import {PatternStream} from './pattern';

export function test_stream_works_without_globals(test) {
  var instance = new PatternStream();
  instance.instance({
    inst1: /(.*)\.foo$/,
    inst2: /(.*)\.bar$/,
  });
...
export function test_stream_works_with_globals(test) {
  var instance = new PatternStream();
  instance.instance({
    inst1: /(.*)\.foo$/,
    inst2: /(.*)\.bar$/,
...
export function test_stream_works_with_deferred_globals(test) {
  var instance = new PatternStream();
  instance.instance({
    inst1: /(.*)\.foo$/,
    inst2: /(.*)\.bar$/,
